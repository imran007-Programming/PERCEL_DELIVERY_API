...
redisClient.on("connect", function () {
    return console.log(":✅ redis Connected successfully");
});
redisClient.on("error", function (err) { return console.log("❌ Redis Error", err); });
var connectRedis = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                if (!!redisClient.isOpen) return [3 /*break*/, 2];
